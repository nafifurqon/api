...
describe ArticlesController do
    describe '#index' do
        ...
        it 'should rerturn articles in the proper order' do
    ...
    describe '#create' do
        ...
        context 'when no code provided request' do
        ...
        context 'when authorized' do
            ...
            context 'when success request sent' do
                ...
                it 'should update the article' do
                    ...
                    expect(article.reload.content).to eq(
                        valid_attributes['data']['attributes']['content']
                    )
                end
            end
        end
